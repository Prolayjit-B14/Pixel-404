...
const photos = [
    ...
    caption: 'Always take the right turn 🔄',
   ...
   },
{
  ...
  caption: 'Finding serenity in the rhythm of the waves 🌊',
  ...
  notes: 'The rising sun casts a golden glow on the sea, highlighting the battle between the ocean waves and the rugged rocks of Digha’s beach.'
},
{
  src: 'asstes/photo3.jpg',
  title: 'Light and Shadow',
  caption: 'The smallest light can cast the longest shadow 🌑🌓🌕',
  location: 'Krishnanagar, West Bengal, India',
  date: '2025-10-20',
  time: '17:50 IST',
  camera: 'Redmi Note 11 Pro+ 5G',
...
},
{
  ...
  caption: 'Light of the Goddess Maa Durga ❤️',
  ...
  editing: {
    ...
    color: 'Warmed Color Temperature while selectively boosting Saturation in the deity shrine’s backdrop.',
    detail: 'Enhanced Clarity and Sharpness on the crystal work and gold carvings.'
  },
  notes: 'An atmospheric capture portraying the majestic chandelier illuminating the divine calm and intricate artistry of Maa Durga’s shrine.'
},
{
  src: 'asstes/photo5.jpg',
  title: 'Golden Reflection',
  caption: 'Holding the last warmth of the day, a tranquil surface mirrors the sun"s fiery kiss🌅',
